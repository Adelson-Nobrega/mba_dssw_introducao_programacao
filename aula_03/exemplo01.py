...
while spam < 5:
    ...
    spam = spam + 1 # também pode ser feito com spam += 1
    time.sleep(1)
...
# Metodo range cria uma lista de números começando no argumento 1, terminando
# no argumento 2 (sem incluí-lo) com o incremento do argumento 3
